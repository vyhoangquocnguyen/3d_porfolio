  ...
  return (
    <section className="max-container">
      ...
      <div className="mt-5 flex-col gap-3 text-slate-500">
        <p>
          Software Engineer, specialise in Web and IoT Development with proven ability to design, implement, and deploy
          scalable applications, successfully bridging hardware data to cloud-based dashboards.
        </p>
      </div>
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            Solutions-driven Software Engineer with a versatile background spanning Embedded Systems (C/C++) and Modern
            Frontend Development (React, Next.js, IoT Integration)
          </p>
        </div>
